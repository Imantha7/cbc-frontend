        ...
        return(
            <div className="w-full h-full pt-4 relative">
                <div className="absolute w-full flex justify-center">
                    <input type="text" className="w-1/2 p-2 absolute z-50" 
                        placeholder="Serach Products" onChange={search}
                        value={query}/>
                 </div>
            {loadingStatus=="loaded" && <div className="w-full h-full overflow-y-scroll flex
            flex-wrap justify-center pt-4 relative">
